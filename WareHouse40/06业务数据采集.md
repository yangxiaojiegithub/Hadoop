...
依次生成 2021-06-01 到 2021-06-07的数据
...
[root@node04 appmain]# chmod +x mysql_to_hdfs_init.sh # 授权
[root@node04 appmain]# ./mysql_to_hdfs_init.sh all 2021-06-01 # 执行
```
...
/opt/stanlong/appmain
[root@node01 appmain]# vi mysql_to_hdfs.sh
```
